    ...
    <nav class="navbar" :class="{ 'navbar-open': mobileNavMenu }">
      <ul>
        ...
        <li v-if="authUser" class="navbar-user">
          ...
          >
            <app-avatar-img class="avatar-small" :src="authUser.avatar" :alt="authUser.name" />
            <span>
              {{ authUser.name }}
...
<!--              <li class="dropdown-menu-item"><a href="#">Log out</a></li>-->
              <li class="dropdown-menu-item"><a @click.prevent="handleSignOut">Sign Out</a></li>
            </ul>
          </div>
        </li>
        ...
        <li v-if="authUser" class="navbar-mobile-item"><a @click.prevent="handleSignOut">Sign Out</a></li>
      </ul>
